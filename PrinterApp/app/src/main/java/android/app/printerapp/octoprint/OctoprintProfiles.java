...
public class OctoprintProfiles {
    ...
    public static void uploadProfile(final Context context, final String url, final JSONObject profile, final String port){
        ...
        try {
            ...
            Log.i("lkj-uploadProfile", "Profile:" + finalProfile.toString());
        ...
        HttpClientHandler.post(context,url + HttpUtils.URL_PROFILES,
                entity, "application/json", new JsonHttpResponseHandler(){
                    ...
                    public void onSuccess(int statusCode,
                        ...
                        Log.i("lkj-uploadProfile", "Profile Upload successful");
                       //lkj  OctoprintConnection.startConnection(url, context, port, finalId);
    ...
    public static void updateProfile(final Context context, final String url, final String profile){
        ...
        try {
            ...
            entity = new StringEntity(finalProfile.toString(), "UTF-8");
            Log.d("lkj-updateProfile", "Profile:" + finalProfile.toString());
        ...
        HttpClientHandler.patch(context,url + HttpUtils.URL_PROFILES + "/" + profile,
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.i("lkj-updateProfile", "Profile PATCH  successful");
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject js){
                Log.i("lkj-updateProfile", "Profile PATCH  FOESNT EXIST");
            }
        });

...
public class DatabaseController {
	...
	public static long writeDb(String name, String address, String position, String type, String network){
		...
		Log.i("lkj-writeDb", "Adding printer: " + name);
		...
		Log.i("lkj-writeDb", "printer id: " + id);
       //lkj MainActivity.refreshDevicesCount();
	...
	public static void updateDB(String tableName, long id, String newValue){
		...
		Log.i("lkj-updateDB", "Updated: " + count + " with " + tableName + " updated with " + newValue + " where " + id);

...
public class LibraryModelCreation {
				...
				if (mainFolder.mkdir()){
                    ...
                    /*    MaterialDialog mDialog =  new MaterialDialog.Builder(mContext)
                        ...
                        */
                        ...
                        mProgressDialog.setMessage("Copying file to local....");
                        mProgressDialog.setCancelable(false);
                        mProgressDialog.setIndeterminate(true);
                        mProgressDialog.show();

                        Log.i("lkj copy file", "show copye file ");
                        final File target = new File(mainFolder.getAbsolutePath() + "/" + mFile.getName());
	...
	private static void openModel (final Context context, final String path) {
        ...
        final List<DataStorage> list = new ArrayList<DataStorage> ();
        ...
        if (StlFile.checkFileSize(file,mContext)) {
            ...
            new MaterialDialog.Builder(mContext)
                    .title("Warning " + "file " + mName + " is too big")
                    .content(R.string.viewer_snapshot_file_size)
                    ...
                    .callback(new MaterialDialog.ButtonCallback() {
                                  ...
                                  public void onNegative(MaterialDialog dialog) {
                                      ...
                                      fis = context.getResources().openRawResource(R.raw.snapshotunknown);
                                      Log.i("lkj scan file", "onNegative button");
                                      try {
                                          ...
                                          Log.i("lkj generate thumb file", " execption=" + e.toString());
                                          e.printStackTrace();
                                      }

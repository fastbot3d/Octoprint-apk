    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!DatabaseController.checkExisting(m)) {
            ...
            v.findViewById(R.id.device_edit_button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                   //lkj appearanceEditDialog(m);
                    //this will for edit profile
                }
            });
            */
            ...
            connectionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (m.getStatus() == StateUtils.STATE_OPERATIONAL) {
                       ...
                       //lkj  OctoprintConnection.getNewConnection(getContext(), m);
                        OctoprintConnection.ConnectionCallBack callBack = new OctoprintConnection.ConnectionCallBack(){
                            public void onSuccess(int statusCode, Header[] headers, JSONObject response){
                                Log.d("lkj-connectionButton", "connection success");
                            }

                            public void onFailure(int statusCode, Header[] headers, String responseString){
                                Log.d("lkj-connectionButton", "connection failed: " + responseString);
                            }
                        };
                        OctoprintConnection.connect_printer(getContext(), m, callBack);
                        connectionButton.setImageResource(R.drawable.ic_settings_connect);
                    }
                }
            });

...
public class EditPrinterDialog {
    ...
    //lkj private static final String[] PRINTER_TYPES = {"bq_witbox", "bq_hephestos", "custom"};
    private static final String[] PRINTER_TYPES = {"custom"};
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        if (spinner_printer.getSelectedItemPosition() != 2) {
                            ...
                            //lkj mPrinter.setTypeAndProfile(spinner_printer.getSelectedItemPosition() + 1, spinner_printer.getSelectedItem().toString());
                            ...
                            //update new profile
                            if (auxType != null) {
                                Log.d("lkj", "address:" + mPrinter.getAddress());
                                Log.d("lkj", "getSelectedItem:" + spinner_port.getSelectedItem().toString());
                                Log.d("lkj", "auxType:" + auxType);

                              //lkj   OctoprintConnection.startConnection(mPrinter.getAddress(), mContext, spinner_port.getSelectedItem().toString(), auxType);
                            ...
                            //lkj mPrinter.setTypeAndProfile(3, null);
                            //Save new profile
                            saveProfile();
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                try {
                    ...
                    if (ModelProfile.saveProfile(mContext, name.getText().toString(), json, ModelProfile.TYPE_P)) {
                        ...
                        //lkj mPrinter.setTypeAndProfile(3, name.getText().toString());
    ...
    public void deleteProfile(final String name) {
        ...
        adb.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //lkj if (ModelProfile.deleteProfile(mContext, name, ModelProfile.TYPE_P)) {

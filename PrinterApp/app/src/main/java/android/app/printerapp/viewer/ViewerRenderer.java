...
public class ViewerRenderer implements GLSurfaceView.Renderer  {
	...
	public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Log.d("lkj-onSurfaceChanged", "Width: " + width + " ; Height: " + height);

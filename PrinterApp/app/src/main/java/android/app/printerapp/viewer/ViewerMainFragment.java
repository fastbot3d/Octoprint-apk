...
public class ViewerMainFragment extends Fragment {
  ...
  //  private static int[] mCurrentPlate = new int[]{WitboxFaces.WITBOX_LONG, WitboxFaces.WITBOX_WITDH, WitboxFaces.WITBOX_HEIGHT};
    private static int[] mCurrentPlate = new int[]{200, 200, 200};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("lkj main framement", "onCreate");
    }
...
//            getActivity().getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    private void initUIElements() {
       ...
       /*lkj  final FrameLayout expandablePanel = (FrameLayout) mRootView.findViewById(R.id.advanced_options_expandable_panel);
...
*/
   ...
   /*lkj     mSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
...
*/
         ...
         * EXTRA
         *****************************/
  //lkj      mProgress = (ProgressBar) mRootView.findViewById(R.id.progress_bar);
  //lkj      mProgress.setVisibility(View.GONE);
   ...
   //     mScaleEditY.addTextChangedListener(mTextWatcherY);
    //    mScaleEditZ.addTextChangedListener(mTextWatcherZ);
     ...
     mStatusBottomBar.setVisibility(View.VISIBLE);
        //lkj      mBottomBar = (FrameLayout) mRootView.findViewById(R.id.bottom_bar);
        //lkj     mBottomBar.setVisibility(View.INVISIBLE);
        mCurrentAxis = -1;
...
*/
    ...
    public static void optionClean() {
        ...
        if (mSlicingHandler!=null){
            ...
            mSlicingHandler.setOriginalProject(null, null);
    ...
    public static void doPress(){
        ...
        //lkj mSurface.doPress(mDataList.size() - 1);
    ...
    public static void openFile(String filePath) {
        ...
        if (mSlicingHandler != null)
            if (mSlicingHandler.getOriginalProject() == null){
                mSlicingHandler.setOriginalProject(mFile.getParentFile().getParent(), mFile.getAbsolutePath());
            } else {
...
//      mLayout.addView(mEditionLayout, 2);
    ...
    public static void hideActionModePopUpWindow() {
		...
		if(mSurface!=null){
        	mSurface.exitEditionMode(); //lkj
        	mSurface.setRendererAxis(-1); //lkj
		}
 ...
 */
                ...
                switch (status) {
                    ...
                    case StateUtils.SLICER_HIDE:
                        ...
                        if (i < 0) {
                            ...
                            tv.setText("Success");
                            //lkj tv.setText(R.string.viewer_text_downloaded);
                        }
    ...
    public void notifyAdapter() {
        ...
        try {
            ...
            Log.d("lkj-notifyAdapter", "0");
            //mSidePanelHandler.reloadProfileAdapter();
            mSidePanelHandler.reloadSliceProfileAdapter();
            if (mSidePanelHandler.s_sliceProfile != null){
                Log.d("lkj-notifyAdapter", "1");
                Object obj = mSidePanelHandler.s_sliceProfile.getSelectedItem();
                String sel = null;
                if(obj != null ){
                    Log.d("lkj-notifyAdapter", "2");
                    sel = obj.toString();
                }
                mSidePanelHandler.parseSlicingJsonFromPrinter(sel);
            }
        } catch (NullPointerException e) {
            e.printStackTrace();
        }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        Log.i("lkj-ViewMainFragment", "onHiddenChanged hidden=" + hidden);
        if(!hidden){
            Log.d("lkj ViewMainFragment", "onHiddenChanged");
            if (mSidePanelHandler.s_sliceProfile != null){
                Object obj = mSidePanelHandler.s_sliceProfile.getSelectedItem();
                String sel = null;
                if(obj != null ){
...
//        task.execute();
    ...
    public static void changePlate(String resource) throws NullPointerException {
      ...
      /*  if (resource.equals("default")) {
            mCurrentPlate = new int[]{200, 200, 200};
        } else {
